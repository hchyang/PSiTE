...
def main(progname=None):
    ...
    group0.add_argument('--start',type=int,default=default,choices=[1,2,3,4],
        help='the serial number of the module from which to start. 1: vcf2fa; 2: phylovar; 3: chain2fa; 4: fa2wgs/fa2wes [{}]'.format(default))
    default=None
    ...
    default='wessim'
    group5.add_argument('--simulator', default=default, choices=['wessim','capgem'], action=TargetAction, type=check_program, help='The whole-exome sequencing simulator used for simulating short reads [{}]'.format(default))
