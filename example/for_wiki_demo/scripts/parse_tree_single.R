...
#####################################################
# Author: Bingxin Lu
# Description: This script is used to visualize the tree of single tumor sample generated by phylovar. The tree was generated by phylovar  from the original input tree. The top clades in the tree whose CCF (Cancer Cell Fraction) is no less than 0.2 are highlighted by different colors. Each clade correponds to a cluster in the simulated data.
